...
contract CreateQuiz is Ownable {
    ...
    function _createQuiz(string memory _question, string memory _choice1, string memory _choice2, string memory _choice3, string memory _choice4, string _hint, uint8 _answer, uint8 _languageCode) private {
